...
import com.mayank.hiddencamerapoc.HiddenCameraUtils.rotateBitmap
import com.mayank.hiddencamerapoc.HiddenCameraUtils.saveImageFromFile
import com.mayank.hiddencamerapoc.config.CameraResolution
import com.mayank.hiddencamerapoc.config.CameraRotation
...
internal class CameraPreview(context: Context, private val mCameraCallbacks: CameraCallbacks) :
    ...
    override fun surfaceChanged(surfaceHolder: SurfaceHolder, i: Int, i1: Int, i2: Int) {
        ...
        cameraSize = when (mCameraConfig!!.resolution) {
            ...
            mCamera!!.takePicture(null, null, { bytes: ByteArray, camera: Camera? ->
                Thread {
                    ...
                    if (mCameraConfig!!.imageRotation != CameraRotation.ROTATION_0) {
                        rotatedBitmap = rotateBitmap(bitmap!!, mCameraConfig!!.imageRotation)
                        bitmap = null
                    } else {
                    ...
                    if (saveImageFromFile(
                        ...
                        Handler(Looper.getMainLooper()).post {
                            mCameraCallbacks.onImageCapture(mCameraConfig?.imageFile!!)
                        }
                    } else {
